...
export default function PeopleAlsoBought() {
  ...
  return (
    <section className="xs:mt-20 mt-24">
      <div className="xs:mb-6.5 xs:gap-3 mb-8 flex flex-col gap-6 md:mb-20">
        <h2 className="xs:hidden text-center text-5xl font-medium text-foreground md:text-[40px]">
          People also bought
        </h2>

        <h2 className="xs:block xs:text-[32px] hidden text-center font-medium text-foreground">
          Related Creations
        </h2>
